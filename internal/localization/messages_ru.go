...
💪 Мышечная релаксация`,
	...
	MenuGuided:    "🧘 Паттерные дыхания 1-2 мин",
	MenuPMR:       "💪 Мышечная релаксация 4 мин",
	MenuLang:      "🌐 Язык",

	// Breathing
	BreathingIntro: `🌬️ *Простое дыхание*
...
Я буду напоминать каждый этап. Готовы начать?`,
	BreathingCompletion: "✅ *Простое дыхание*\n\nГотово. Можно двигаться дальше.",
...
Я проведу вас через каждый шаг. Готовы начать?`,
	GroundingCompletion: "✅ *Заземление 5-4-3-2-1*\n\nВы справились с чем-то непростым.",
...
`,
	GuidedCompletion: "✅ *Паттерные дыхания*\n\nГотово. Можно двигаться дальше.",
...
Я проведу вас через каждый цикл. Готовы начать?`,
...
Я проведу вас через каждую группу мышц. Готовы начать?`,
	PMRTense:      "🔴 *НАПРЯГИТЕ*\n\n%s",
	PMRRelax:      "🟢 *РАССЛАБЬТЕ*\n\n%s",
	PMRCompletion: "✅ *Мышечная релаксация*\n\nТело поработало. Теперь просто будьте.",
