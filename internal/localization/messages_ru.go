...
Медленно возвращайтесь в реальность. Пошевелите пальцами и сделайте глубокий вдох.
...
Выберите технику из меню ниже.`,
	...
	VisualizationCloseEyes:  "Погрузитесь в эту сцену...",
	...
	SceneMountainStep1: "Представьте, что вы стоите на вершине горы ранним утром.",
	...
	SceneGardenStep5: "Вы садитесь на скамейку у фонтана и наслаждаетесь моментом.",
