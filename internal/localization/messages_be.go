...
💪 Мышачная рэлаксацыя`,
	...
	MenuPMR:       "💪 Мышачная рэлаксацыя 4 хв",
	MenuLang:      "🌐 Мова",

	// Breathing
	BreathingIntro: `🌬️ *Простае дыханне*
...
Я буду нагадваць кожны этап. Гатовы пачаць?`,
	BreathingCompletion: "✅ *Простае дыханне*\n\nГатова. Можна рухацца далей.",
...
Я правяду вас праз кожны крок. Гатовы пачаць?`,
	GroundingCompletion: "✅ *Зазямленне 5-4-3-2-1*\n\nВы справіліся з чымсьці няпростым.",
...
`,
	GuidedCompletion: "✅ *Патэрны дыхання*\n\nГатова. Можна рухацца далей.",
...
Я правяду вас праз кожны цыкл. Гатовы пачаць?`,
...
Я правяду вас праз кожную групу мышцаў. Гатовы пачаць?`,
	PMRTense:      "🔴 *НАПРУЖЦЕ*\n\n%s",
	PMRRelax:      "🟢 *РАССЛАБЦЕ*\n\n%s",
	PMRCompletion: "✅ *Мышачная рэлаксацыя*\n\nЦела папрацавала. Проста адпачывайце.",
